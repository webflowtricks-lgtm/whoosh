    ...
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center items-center p-6 relative select-none">
      ...
      {onBack && (
        <button
          ...
          className="absolute top-6 left-6 z-20 p-3 rounded-xl bg-slate-900/90 border border-slate-800 hover:border-orange-500/80 hover:text-orange-400 transition-all cursor-pointer text-slate-400 shadow"
          title={t('Voltar ao Menu', 'Back to Menu')}
        >
